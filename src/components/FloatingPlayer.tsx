...
const EMBED_URL = `https://w.soundcloud.com/player/?url=${encodeURIComponent(
  "https://soundcloud.com/djandykofficial/this-is-dj-andyk-music-is-your-passion-official-album-intro-2025"
  ...
  return (
    <>
      ...
      <div
        ...
        className={`fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-[60] w-[calc(100vw-2rem)] max-w-[320px] glass-card rounded-2xl p-3.5 flex items-center gap-3 shadow-[0_8px_40px_rgba(0,0,0,0.1)] transition-all duration-500 ${
          visible
